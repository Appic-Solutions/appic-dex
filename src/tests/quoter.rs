...
#[test]
pub fn test_quoter_exact_input_different_extremely_low_liquidity_should_fail() {
    // set 60 as tick spacing for 3000 bips fee
    mutate_state(|s| {
        s.set_tick_spacing(
            crate::pool::types::PoolFee(3000),
    ...
    let pool1 = create_pool(CreatePoolArgs {
        ...
        token_b: token_1,
        fee: Nat::from(3000_u32),
        sqrt_price_x96: Nat::from(u256_to_big_uint(U256::from(
            21308571830258156734264619446808415_u128,
        ))),
    });
    ...
    let modify_liquidity_params = ModifyLiquidityParams {
        ...
        tick_lower: 249_720,
        tick_upper: 250_440,
        liquidity_delta: 155569146053502_i128,
    ...
    mutate_state(|s| s.apply_modify_liquidity_buffer_state(modify_liquidity_result.buffer_state));

    let pool_state = read_state(|s| s.get_pool(&pool1));
    println!("{:?}", pool_state);

    //let amount_in = U256::from(100_u128);
    let amount_in = U256::from(100000000_u128);
    ...
    let result = process_single_hop_exact_input(params);
    println!("{:?}", result);
...
#[test]
pub fn test_quoter_exact_input_different_extremely_high_liquidity_multiple_positions() {
    // set 60 as tick spacing for 3000 bips fee
    mutate_state(|s| {
        s.set_tick_spacing(
            crate::pool::types::PoolFee(3000),
    ...
    let pool1 = create_pool(CreatePoolArgs {
        ...
        fee: Nat::from(3000_u32),
        sqrt_price_x96: Nat::from(u256_to_big_uint(U256::from(
            22_649_454_215_061_348_479_605_591_547_u128,
        ))),
    });
    ...
    let modify_liquidity_params = ModifyLiquidityParams {
        ...
        tick_lower: -887_220,
        tick_upper: 887_220,
        liquidity_delta: 283_758_354_i128,
        tick_spacing: PoolTickSpacing(60),
    };
    let modify_liquidity_result =
        modify_liquidity(modify_liquidity_params).expect("Failed to modify liquidity");
    ...
    let modify_liquidity_params = ModifyLiquidityParams {
        ...
        tick_lower: -27_360,
        tick_upper: -21_900,
        liquidity_delta: 247_096_992_i128,
        tick_spacing: PoolTickSpacing(60),
    };
    let modify_liquidity_result =
        modify_liquidity(modify_liquidity_params).expect("Failed to modify liquidity");
    ...
    let amount_in = U256::from(10000000000_u128);
    ...
    let result = process_single_hop_exact_input(params).unwrap();

    assert_eq!(result, U256::from(81423269_u128));
}
