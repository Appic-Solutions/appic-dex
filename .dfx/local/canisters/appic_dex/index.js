...
import { idlFactory } from './appic_dex.did.js';
export { idlFactory } from './appic_dex.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_APPIC_DEX;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./appic_dex.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the appic_dex canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./appic_dex.did.js")._SERVICE>}
 */
export const appic_dex = createActor(canisterId);
